...
public class AddPrinterActivity extends AppCompatActivity implements Runnable{
    ...
    Toolbar toolbar;
    @BindView(R.id.textAddPrinter)
    TextView textAddPrinter;
    @BindView(R.id.textRemovePrinter)
    TextView textRemovePrinter;
    ...
    public void AddPrinter() {
        ...
        if (mBluetoothAdapter == null) {
            ...
            if (!mBluetoothAdapter.isEnabled()) {
                ...
                ListPairedDevices();
                Intent connectIntent = new Intent(this,DeviceList.class);
    ...
    @OnClick(R.id.textRemovePrinter)
    ...
    protected void onActivityResult(int mRequestCode, int mResultCode, Intent data) {
        ...
        switch (mRequestCode) {
            ...
            case REQUEST_ENABLE_BT:
                if (mResultCode == Activity.RESULT_OK) {
                    ListPairedDevices();
                    Intent connectIntent = new Intent(AddPrinterActivity.this,DeviceList.class);
